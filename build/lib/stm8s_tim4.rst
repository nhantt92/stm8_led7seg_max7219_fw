      ...
      0087F2 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      0087F3                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      0087F3 AE 53 47         [ 2]   71 	ldw	x, #0x5347
      0087F6 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      0087F8 F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      0087F9 AE 53 48         [ 2]   75 	ldw	x, #0x5348
      0087FC 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      0087FE F7               [ 1]   77 	ld	(x), a
      0087FF 81               [ 4]   78 	ret
      ...
      008822 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      008823                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      008823 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      008825 43               [ 1]  134 	cpl	a
      008826 AE 53 44         [ 2]  135 	ldw	x, #0x5344
      008829 F7               [ 1]  136 	ld	(x), a
      00882A 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      00882B                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      00882B 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      00882D 43               [ 1]  145 	cpl	a
      00882E AE 53 44         [ 2]  146 	ldw	x, #0x5344
      008831 F7               [ 1]  147 	ld	(x), a
      008832 81               [ 4]  148 	ret
                                    149 	.area CODE
