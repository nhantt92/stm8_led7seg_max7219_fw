      ...
      0096BA 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      0096BB                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      0096BB AE 53 47         [ 2]   71 	ldw	x, #0x5347
      0096BE 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      0096C0 F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      0096C1 AE 53 48         [ 2]   75 	ldw	x, #0x5348
      0096C4 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      0096C6 F7               [ 1]   77 	ld	(x), a
      0096C7 81               [ 4]   78 	ret
      ...
      0096EA 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      0096EB                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      0096EB 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      0096ED 43               [ 1]  134 	cpl	a
      0096EE AE 53 44         [ 2]  135 	ldw	x, #0x5344
      0096F1 F7               [ 1]  136 	ld	(x), a
      0096F2 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      0096F3                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      0096F3 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      0096F5 43               [ 1]  145 	cpl	a
      0096F6 AE 53 44         [ 2]  146 	ldw	x, #0x5344
      0096F9 F7               [ 1]  147 	ld	(x), a
      0096FA 81               [ 4]  148 	ret
                                    149 	.area CODE
